...
if($u == $log_username && $user_ok == true){
    ...
    $photo_form .=   '<h3>Hi '.$u.', add a new graphic into your portfolio</h3>';
    ...
    $photo_form .=     '<option value="Illustrations">Illustrations</option>';
    $photo_form .=   '</select>';
   ...
   <!-- <meta name="viewport" content="width=device-width, initial-scale=1"> -->
    ...
    <script>
        ...
        function backToGalleries(){
            ...
            _("section_title").innerHTML = "<?php echo $u; ?>&#39;s Portfolio";
...
<?php include_once("php_includes/userPageTop.php"); ?>
    ...
    <div id="pageMiddle" style="width:100%; background-color: #7ead21; padding:25px; color:#ffffff">
        ...
        <h2 id="section_title"><?php echo $u; ?>&#39;s Portfolio</h2>

...
if($user_ok == true) {
    ...
    $member_search = '<div id="memSearch">
...
<nav class="navbar navbar-default navbar-inverse navbar-fixed-top" role="navigation" >
    <div class="container-fluid" style="min-width: 1200px;">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="../index.php"><img class="navlogo" src="../images/logofornavbar.png" alt="logo" style="margin-top:-12px;"></a>
        </div>

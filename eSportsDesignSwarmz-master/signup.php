...
if(isset($_POST["u"])){
    ...
    $ref = mysqli_real_escape_string($db_conx, $_POST['ref']);
    // GET USER IP ADDRESS
    ...
    if($u == "" || $e == "" || $p == "" || $dorc == "" || $c == "" || $age ==""){
        ...
        $p_hash = password_hash($p, PASSWORD_BCRYPT,array("cost" =>9));
        //$cryptpass = crypt($p);
        ...
        $sql = "INSERT INTO users (username, email, password, age, dorc,ref_by, country, ip, signup, lastlogin, notescheck)
                    VALUES('$u','$e','$p_hash','$age','$dorc','$ref','$c','$ip',now(),now(),now())";
        $query = mysqli_query($db_conx, $sql);
            ...
            <div class="col-lg-12">
                ...
                <form id="signupform" onsubmit="return false;" role="form">
                    ...
                    <div style="width:250px; margin:auto;">
                        <label for="referral"> Refered By: </label>
                        <input type="email" class="form-control" id="referral" placeholder="Refered By: Enter Email">
                    </div><br/><br/>
...
<script>
    ...
    function signup(){
        ...
        var status = _("status");
        var age = _("age").value;
        var ref = _("referral").value;
        var agree = document.getElementById("agree").checked;

        if(u == "" || e == "" || e2 == ""|| p1 == "" || p2 == "" || c == "" || dorc == "" || age == ""){
            ...
            ajax.send("u="+u+"&e="+e+"&p="+p1+"&c="+c+"&dorc="+dorc+"&age="+age+"&ref="+ref);
        }
    }
